...
def parse_opt(known=False):
    ...
    parser.add_argument('--imgsz', '--img-size', '--img', type=int, default=640, help='train, val image size (pixels)')
    ...
    parser.add_argument('--angmode', type=str, choices=['OOCV', 'LE90'], default='LE90', help='Bbox Angular mode')
